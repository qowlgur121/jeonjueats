<template>
  <div class="privacy-policy">
    ...
    <div class="content">
      <div class="section">
        <h2>1. 개인정보의 처리목적</h2>
        <p>전주이츠(이하 "회사")는 다음의 목적을 위하여 개인정보를 처리합니다.</p>
        <ul>
          <li>회원 가입 및 관리</li>
      ...
      <div class="section">
        ...
        <ul>
          ...
          <li>자동생성정보: 접속 IP, 쿠키, 서비스 이용기록</li>
        </ul>
      </div>
      ...
      <div class="section">
        ...
        <div class="contact-info">
          ...
          <p>이메일: privacy@jeonjueats.com</p>
          <p>전화번호: 063-123-4567</p>
        </div>
      </div>
      ...
      <div class="effective-date">
        <p><strong>시행일자: 2025년 6월 10일</strong></p>
      </div>
    </div>
  </div>
</template>
